...
public class ChmuMeasurementsScraper implements NonLocationBasedScraper<CloudCoverageMeasurements> {
    ...
    private final ChmuMeasurementsScraperProps properties;
    private final LocationConfigRepository locationConfigRepository;

    public ChmuMeasurementsScraper(ChmuMeasurementsScraperProps properties, LocationConfigRepository locationConfigRepository) {
